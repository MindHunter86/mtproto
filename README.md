...
**english** [русский](https://github.com/MindHunter86/mtproto/blob/main/docs/ru_RU/README.md) [简体中文](https://github.com/MindHunter86/mtproto/blob/main/docs/zh_CN/README.md)
...
**Code examples are [here](https://github.com/MindHunter86/mtproto/blob/main/examples)**

**Full docs are [here](https://pkg.go.dev/github.com/MindHunter86/mtproto)**
...
**Example [here](https://github.com/MindHunter86/mtproto/blob/main/examples/auth)**
...
Want to deal those freaky `tg://` links? See [`deeplinks` package](https://github.com/MindHunter86/mtproto/blob/main/telegram/deeplinks), here is the simplest how-to:
...
Please read [contributing guide](https://github.com/MindHunter86/mtproto/blob/main/.github/CONTRIBUTING.md) if you want to help. And the help is very necessary!

**Don't want code?** Read [this](https://github.com/MindHunter86/mtproto/blob/main/.github/SUPPORT.md) page! We love nocoders!

## Security bugs?

Please, don't create issue which describes security bug, this can be too offensive! Instead, please read [this notification](https://github.com/MindHunter86/mtproto/blob/main/.github/SECURITY.md) and follow that steps to notify us about problem.
...
This project is licensed under the MIT License - see the [LICENSE](https://github.com/MindHunter86/mtproto/blob/main/LICENSE.md) file for details
