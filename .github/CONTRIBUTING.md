...
**english** [русский](https://github.com/MindHunter86/mtproto/blob/main/docs/ru_RU/CONTRIBUTING.md)
...
We all want to make other people happy! We believe that you are a good guy, but please, just in case, read our [code of conduct](https://github.com/MindHunter86/mtproto/blob/main/.github/CODE_OF_CONDUCT.md). They will help you understand what ideals we adhere to, among other things, you will be even more cool!
...
And we also actually want to do [FAQ](https://github.com/MindHunter86/mtproto/discussions/categories/q-a), but we don’t know what questions to write there, so, if you are reading this, probably write while in the Telegram, we'll figure it out :)
