...
[![godoc reference](https://pkg.go.dev/badge/github.com/MindHunter86/mtproto?status.svg)](https://pkg.go.dev/github.com/MindHunter86/mtproto)
[![Go Report Card](https://goreportcard.com/badge/github.com/MindHunter86/mtproto)](https://goreportcard.com/report/github.com/MindHunter86/mtproto)
[![codecov](https://codecov.io/gh/xelaj/mtproto/branch/master/graph/badge.svg)](https://codecov.io/gh/xelaj/mtproto)
[![license MIT](https://img.shields.io/badge/license-MIT-green)](https://github.com/MindHunter86/mtproto/blob/main/README.md)
...
[english](https://github.com/MindHunter86/mtproto/blob/main/README.md) **русский** [简体中文](https://github.com/MindHunter86/mtproto/blob/main/docs/zh_CN/README.md)
...
**Примеры кода [здесь](https://github.com/MindHunter86/mtproto/blob/main/examples)**

**Полная документация [здесь](https://pkg.go.dev/github.com/MindHunter86/mtproto)**
...
``` bash
go get github.com/MindHunter86/mtproto
```
...
``` bash
go generate github.com/MindHunter86/mtproto
```
...
**Пример [здесь](https://github.com/MindHunter86/mtproto/blob/main/examples/auth)**
...
Нужно работать с этими стрёмными `tg://` ссылками? Загляните в [пакет `deeplinks`](https://github.com/MindHunter86/mtproto/blob/main/telegram/deeplinks), вот самый простейший пример:
...
import (
    ...
    "github.com/MindHunter86/mtproto/telegram/deeplinks"
)
...
Please read [contributing guide](https://github.com/MindHunter86/mtproto/blob/main/docs/ru_RU/CONTRIBUTING.md) if you want to help. And the help is very necessary!

**Don't want code?** Read [this](https://github.com/MindHunter86/mtproto/blob/main/.github/SUPPORT.md) page! We love nocoders!

## Критические уязвимости?

Ага, мы стараемся подходить к ним серьезно. Пожалуйста, не создавайте ищью, описывающие ошибку безопасности, это может быть ОЧЕНЬ небезопасно! Вместо этого рекомендуем глянуть на [эту страничку](https://github.com/MindHunter86/mtproto/blob/main/.github/SECURITY.md) и следовать инструкции по уведомлению.
...
This project is licensed under the MIT License - see the [LICENSE](https://github.com/MindHunter86/mtproto/blob/main/docs/ru_RU/LICENSE.md) file for details
