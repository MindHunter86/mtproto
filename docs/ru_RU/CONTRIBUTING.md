...
[english](https://github.com/MindHunter86/mtproto/blob/main/.github/CONTRIBUTING.md) **русский**
...
А еще мы вообще-то хотим сделать [ЧеКаво](https://github.com/MindHunter86/mtproto/discussions/categories/q-a), но не знаем, какие вопросы туда писать, так что, если вы это читаете, наверное, пишите пока в телегу, там разберемся :)
